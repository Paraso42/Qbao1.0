    ...
    >
      ...
      >
        ...
        <img
          ...
          alt="警长"
          :src="`${GAME_BASE}/assets/sheriff${theme}.svg`"
          class="sherrif"
        />
        <img
          class="dead"
          ...
          v-show="!item.isAlive"
          alt="骷髅"
          :src="`${GAME_BASE}/assets/dead${theme}.svg`"
        />
      </div>
...
<script lang="ts">
  ...
  import { GAME_BASE } from "../../shared/constants";
  ...
  const RoomPlayerList = defineComponent({
    ...
    components: {},
    setup(props) {
      return { GAME_BASE, theme, setTarget, target, isActing };
    },
  });
